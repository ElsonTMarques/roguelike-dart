...
class MundoBuilder {
  ...
  List<Carneiro> carneiro;
  List<Lobo> lobo;
  List<Tesouro> tesouro;
  ...
  // Método que adiciona criaturas no mapa
  // @quantidadeCriaturas : número de criaturas que queremos colocar no mapa
  MundoBuilder criarCarneiros(int quantidadeCriaturas) {
    // cria um número aleatório
    Random aleatorio = Random();
    int x, y;
    // Cria N criaturas
    for (int i = 0; i < quantidadeCriaturas; i++) {
      ...
      // Adiciona a criatura na lista de criaturas
      carneiro.add(Carneiro(Ponto2D(x,y), Carneiro.SIMBOLO_CRIATURA));
    }
    return this;
  }
    ...
    // Método que adiciona criaturas no mapa
  // @quantidadeCriaturas : número de criaturas que queremos colocar no mapa
  MundoBuilder criarLobos(int quantidadeCriaturas) {
    // cria um número aleatório
    Random aleatorio = Random();
    int x, y;
    // Cria N criaturas
    for (int i = 0; i < quantidadeCriaturas; i++) {
      ...
      // Adiciona a criatura na lista de criaturas
      lobo.add(Lobo(Ponto2D(x,y), Lobo.SIMBOLO_CRIATURA));
    }
    return this;
  }
    ...
    // Método que adiciona criaturas no mapa
  // @quantidadeCriaturas : número de criaturas que queremos colocar no mapa
  MundoBuilder criarTesouros(int quantidadeCriaturas) {
    // cria um número aleatório
    Random aleatorio = Random();
    int x, y;
    // Cria N criaturas
    for (int i = 0; i < quantidadeCriaturas; i++) {
      ...
      // Adiciona a criatura na lista de criaturas
      tesouro.add(Tesouro(Ponto2D(x,y), Tesouro.SIMBOLO_CRIATURA));
    }
    return this;
  }
  ...
  // Retorna um Mundo
  Mundo build() {
    return Mundo(mapa, criaturas, carneiro, lobo, tesouro);
  }
}
