...
class Lobo extends Personagem {
  ...
  void atualizar(Mundo mundo) {
    ...
    if (direcaoX == posicao.x-2 && direcaoY == posicao.y) {
      mover(mundo, -1, 0);
    } else if (direcaoX == posicao.x+2 && direcaoY == posicao.y) {
      mover(mundo, 1, 0);
    } else if (direcaoY == posicao.y+2 && direcaoX == posicao.x) {
      mover(mundo, 0, 1);
    } else if (direcaoY == posicao.y-2 && direcaoX == posicao.x) mover(mundo, 0, -1);
